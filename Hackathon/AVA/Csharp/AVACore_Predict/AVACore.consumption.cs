...
namespace AVACore_Predict
{
    public partial class AVACore
    {
        ...
        /// <summary>
        /// model output class for AVACore.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("AVACore.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Month");
            if (labelColumn == null)
            {
                throw new Exception("Month column not found. Make sure the name searched for matches the name in the schema.");
            }
