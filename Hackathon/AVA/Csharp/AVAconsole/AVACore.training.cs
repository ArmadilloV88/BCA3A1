...
namespace AVAconsole
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\ccver\Desktop\VC\BCA3A1\Hackathon\AVA\Csharp\corefx-issues-train.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"ID", @"ID")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Area",inputColumnName:@"Area",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.1,LabelColumnName=@"Area",FeatureColumnName=@"Features"}),labelColumnName: @"Area"))      
